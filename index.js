...
var FloatingLabel  = createReactClass({
    ...
    getInitialState () {
        ...
        state.labelStyle = {
            ...
            opacity: new Animated.Value(style.opacity)
        }

        state.borderBotomColor = '#bebebe';
        state.borderBotomWhidth = 0.5;
    ...
    _onFocus () {
        this._animate(true)
        this.setState({dirty: true , borderBotomColor: '#9657ff'})
    ...
    _onBlur () {
        ...
        this.setState({borderBotomColor: '#bebebe' });
    ...
    render() {
        var props = {
                ...
                selectionColor: this.props.selectionColor, // add this
        ...
        return (
            ...
            <View style={[elementStyles,{borderColor: this.state.borderBotomColor }]}>
                {this._renderLabel()}
                <TextInput
                    {...props}
                >
